...
public class JavaTypeResolver {
    ...
    /**
     * 根据jdbc type得到jdbc type name
     * @param jdbcType 参见Types
     * @return jdbc type name
     */
    public String resolveJDBCTypeName(int jdbcType){
    ...
    /**
     * 根据jdbc类型得到全限定Java类型
     * @param jdbcType jdbc类型，参见Types
     * @return 全限定Java类型
     */
    public FullyQualifiedJavaType resolveJavaType(int jdbcType){
        JdbcTypeInformation jdbcTypeInformation = typeMap.get(jdbcType);
