...
public class JavaTypeResolverConfiguration extends TypeHolder{
    /**
     * 构造函数
     *
     ...
     */
    public JavaTypeResolverConfiguration(Properties systemProperties, Properties extraProperties, Properties configProperties) {
