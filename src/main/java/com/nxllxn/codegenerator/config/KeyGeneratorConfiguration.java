 ...
 * @author wenchao
 */
public class KeyGeneratorConfiguration extends PositionTypeHolder {
    /**
     * 构造函数
     *
     ...
     */
    public KeyGeneratorConfiguration(Properties systemProperties, Properties extraProperties, Properties configProperties) {
